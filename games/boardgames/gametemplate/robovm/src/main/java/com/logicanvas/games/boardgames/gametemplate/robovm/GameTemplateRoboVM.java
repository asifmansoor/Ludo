package com.logicanvas.games.boardgames.gametemplate.robovm;
...
public class GameTemplateRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, GameTemplateRoboVM.class);
    pool.close();
  }
}
