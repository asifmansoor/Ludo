package com.logicanvas.frameworks.boardgamesgdk.robovm;
...
public class BoardGamesCoreRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, BoardGamesCoreRoboVM.class);
    pool.close();
  }
}
