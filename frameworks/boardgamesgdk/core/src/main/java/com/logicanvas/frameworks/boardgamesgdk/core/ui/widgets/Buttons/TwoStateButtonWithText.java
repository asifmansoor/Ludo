...
public class TwoStateButtonWithText extends TwoStateButton {
    ...
    public TwoStateButtonWithText(Image.Region active, Image.Region pressed, float x, float y, float width, float height,
                                  Graphics gfx, TextFormat format, TextWrap wrap, String text, CallBack callBackImpl) throws ButtonCreationException {
